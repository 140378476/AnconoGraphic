...
import cn.ancono.math.geometry.visual2D.PlaneDrawer;
import cn.ancono.math.geometry.visual2D.SubstitutableCurve;
...
public class DrawPlaneCurveSample {
    public static void sample1() {
        ...
        drawer.addCurve(Color.BLUE, SubstitutableCurve.mapToDouble(AB));
        drawer.addCurve(Color.BLUE, SubstitutableCurve.mapToDouble(CD));
